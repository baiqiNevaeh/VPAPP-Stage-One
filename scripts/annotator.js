    ...
    var Editor = {
        ...
        renderEditorTemplate: function() {
            ...
            html += '</li>'
                ...
                +          '<textarea class="js-note-field" placeholder="ALL you need is to input the number of difficulty levels.&#10;Difficulty level:&#10;1-You can totally understand it. /You can exactly know its meaning.&#10;2-You can easily understand it based on the contexts.&#10;3-You can understand it based on the contexts, but you may need a little time.&#10;4-You may guess its meaning based on the contexts, but you are not sure about it.&#10;5-You cannot understand it."></textarea>'
                +          '<input type="submit" id="add-button" value="Add Difficulty Level" />'
                +      '</form>'
                +  '</li>'
        ...
        saveToSessionStorage: function() {
            ...
            if(localStorage) {
                ...
                localStorage.setItem("annotations", JSON.stringify(serializedAnnotations));
            }
            // window.sessionStorage.removeItem("annotations", JSON.stringify(serializedAnnotations));
            // localStorage.clear();
        }
...
var JSonToCSV = {
    ...
    setDataConver: function(obj) {
        ...
        var fileName = (obj['fileName'] || 'UserExport') + '.csv';
